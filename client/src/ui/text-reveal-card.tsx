    ...
    (<div
      ...
      <div className="h-20  relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#7f7c7ce2] z-20  will-change-transform">
          <p
            style={{
              textShadow: "4px 4px 15px rgba(156, 151, 151, 0.629)",
            }}
            className="text-base sm:text-[3rem] pl-12 py-10 font-bold  text-black bg-clip-text text-transparent bg-gradient-to-b from-purple-200 to-purple-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-base sm:text-[3rem] pl-8 py-10 font-bold bg-clip-text text-transparent bg-[#9a9a9aae]">
            {text}
          </p>
          <MemoizedStars />
        </div>
