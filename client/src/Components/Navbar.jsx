...
//     return (
//         <nav className='fixed mx-auto top-0 left-0 right-0 z-10 bg-[#000000] bg-opacity-70 backdrop-blur-md shadow-custom-blur'>
//             <div className='flex flex-wrap items-center justify-between mx-auto px-4 py-2'>
//                 <a href={"/"} className='text-2xl md:text-5xl text-white font-semibold'>
//                     R
//                 </a>

//                 <div className='px-3 py-2 block md:hidden'>
