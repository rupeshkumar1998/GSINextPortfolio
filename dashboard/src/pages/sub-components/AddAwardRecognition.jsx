...
const AddAwardRecognition = () => {
    ...
    const { loading, message, error } = useSelector((state) => state.awardRecognition);
    const dispatch = useDispatch();
    const handleAddNewAwardRecognition = (e) => {
      e.preventDefault();
      ...
      dispatch(addNewAwardRecognition(formData));
    };
    ...
    return (
      <>
        <div className="flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14 bg-purple-50">
          <form className="w-[100%] px-5 md:w-[650px]" onSubmit={handleAddNewAwardRecognition}>
            <div className="space-y-12">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="font-semibold leading-7 text-gray-900 text-3xl text-center">
                  Add a new Award Recognitions
                </h2>
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                {!loading ? (
                  <Button type="submit" className="w-full">
                    Add AwardRecognition
                  </Button>
                ) : (
                  <SpecialLoadingButton content={"Adding New AwardRecognition"} />
                )}
              </div>
              </div>
            </form>
  ...
  export default AddAwardRecognition;
